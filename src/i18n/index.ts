...
const resources = {
  es: {
    translation: {
      ...
      shops: {
        ...
        sectionDescription:
          "Encuentra puntos de venta cercanos a tu ubicación y filtra por distancia.",
        useMyLocation: "Usar mi ubicación",
        searchingLocation: "Buscando ubicación…",
        locationEnabled: "Ubicación activada",
        searchModal: {
          ariaView: "Ver puntos de venta",
          viewButton: "Ver puntos de venta",
          title: "Encuentra tu punto de venta",
          ariaClose: "Cerrar",
        },
        mapWidget: {
          title: "Tiendas",
        ...
        sortByName: "Nombre",
        onlyWithinRadius: "Mostrar solo dentro del radio",
        loading: "Cargando…",
        locationsCount: "{{count}} locales",
        enableLocationToFilter: "Activa tu ubicación para filtrar por radio",
        listTitle: "Puntos de venta",
        listTitleNearby: "Puntos de venta cercanos",
        listSortedByDistance: "Ordenados por cercanía",
        enableLocationToSeeDistances: "Activa tu ubicación para ver distancias",
        noMatches: "No hay locales que coincidan con los filtros.",
        openInMaps: "Abrir en Maps",
        mapTitle: "Puntos de venta MAN POWERS",
        yourLocation: "Tu ubicación",
        errorTitle: "Tiendas",
        errorLoadShops: "No se pudieron cargar las tiendas.",
      ...
      "cart.eligibleSubtotal": "Subtotal (categoría)",
      "cart.discountApplied": "Descuento aplicado",
      "cart.promoExclusiveCategory":
        "Este código es exclusivo de: {{category}}",
      "cart.emailLabel": "Envío y contacto",
      "cart.emailInputLabel": "Email",
      "cart.emailPlaceholder": "Tu email para recibir los datos de la compra",
      "cart.invalidEmail": "Introduce un email válido",
      "cart.contactDetailsTitle": "Datos personales",
      "cart.shippingDetailsTitle": "Envío",
      "cart.firstNameLabel": "Nombre",
      "cart.lastNameLabel": "Apellido",
      "cart.secondLastNameLabel": "Segundo apellido (opcional)",
      "cart.firstNameRequired": "El nombre es obligatorio",
      "cart.lastNameRequired": "El apellido es obligatorio",
      "cart.phoneRequired": "El teléfono es obligatorio",
      ...
      "product.selectColor": "Selecciona color",
      "product.clearance": "Liquidación",
  ...
  ca: {
    translation: {
      ...
      shops: {
        sectionTitle: "Punts de venda",
        sectionDescription:
          "Troba punts de venda a prop de la teva ubicació i filtra per distància.",
        useMyLocation: "Utilitzar la meva ubicació",
        searchingLocation: "Cercant ubicació…",
        locationEnabled: "Ubicació activada",
        searchModal: {
          ariaView: "Veure punts de venda",
          viewButton: "Veure punts de venda",
          title: "Troba el teu punt de venda",
          ariaClose: "Tancar",
        },
        mapWidget: {
          title: "Botigues",
          errorTitle: "Mapa",
          locationsCount: "{{count}} ubicacions",
        },
        filtersTitle: "Filtres",
        clear: "Netejar",
        searchLabel: "Cerca",
        searchPlaceholder: "Nom o adreça…",
        radiusLabel: "Radi",
        sortLabel: "Ordre",
        sortByDistance: "Proximitat",
        sortByName: "Nom",
        onlyWithinRadius: "Mostra només dins del radi",
        loading: "Carregant…",
        locationsCount: "{{count}} locals",
        enableLocationToFilter: "Activa la teva ubicació per filtrar per radi",
        listTitle: "Punts de venda",
        listTitleNearby: "Punts de venda propers",
        listSortedByDistance: "Ordenats per proximitat",
        enableLocationToSeeDistances:
          "Activa la teva ubicació per veure distàncies",
        noMatches: "No hi ha locals que coincideixin amb els filtres.",
        openInMaps: "Obrir a Maps",
        mapTitle: "Punts de venda MAN POWERS",
        yourLocation: "La teva ubicació",
        errorTitle: "Botigues",
        errorLoadShops: "No s'han pogut carregar les botigues.",
      ...
      "cart.eligibleSubtotal": "Subtotal (categoria)",
      "cart.discountApplied": "Descompte aplicat",
      "cart.promoExclusiveCategory": "Aquest codi és exclusiu de: {{category}}",
      ...
      "cart.contactDetailsTitle": "Dades personals",
      "cart.shippingDetailsTitle": "Enviament",
      "cart.firstNameLabel": "Nom",
      "cart.lastNameLabel": "Cognom",
      "cart.secondLastNameLabel": "Segon cognom (opcional)",
      "cart.firstNameRequired": "El nom és obligatori",
      "cart.lastNameRequired": "El cognom és obligatori",
      "cart.phoneRequired": "El telèfon és obligatori",
  ...
  en: {
    translation: {
      ...
      shops: {
        sectionTitle: "Points of sale",
        sectionDescription:
          "Find points of sale near your location and filter by distance.",
        useMyLocation: "Use my location",
        searchingLocation: "Getting location…",
        locationEnabled: "Location enabled",
        searchModal: {
          ariaView: "View points of sale",
          viewButton: "View points of sale",
          title: "Find your point of sale",
          ariaClose: "Close",
        },
        mapWidget: {
          title: "Stores",
        ...
        sortByName: "Name",
        onlyWithinRadius: "Show only within radius",
        loading: "Loading…",
        locationsCount: "{{count}} locations",
        enableLocationToFilter: "Enable your location to filter by radius",
        listTitle: "Points of sale",
        listTitleNearby: "Nearby points of sale",
        listSortedByDistance: "Sorted by distance",
        enableLocationToSeeDistances: "Enable your location to see distances",
        noMatches: "No locations match the filters.",
        openInMaps: "Open in Maps",
        mapTitle: "MAN POWERS points of sale",
        yourLocation: "Your location",
        errorTitle: "Stores",
        errorLoadShops: "Could not load stores.",
      ...
      "cart.eligibleSubtotal": "Subtotal (category)",
      "cart.discountApplied": "Discount applied",
      "cart.promoExclusiveCategory": "This code is exclusive to: {{category}}",
      ...
      "cart.contactDetailsTitle": "Personal details",
      "cart.shippingDetailsTitle": "Shipping",
      "cart.firstNameLabel": "First name",
      "cart.lastNameLabel": "Last name",
      "cart.secondLastNameLabel": "Second last name (optional)",
      "cart.firstNameRequired": "First name is required",
      "cart.lastNameRequired": "Last name is required",
      "cart.phoneRequired": "Phone is required",
