...
const resources = {
  es: {
    translation: {
      ...
      "privacy.legalBasisText": "Ejecución de contrato, cumplimiento de obligaciones legales e interés legítimo. Para marketing y analítica, se solicitará tu consentimiento.",
      "privacy.recipientsTitle": "Destinatarios",
      "privacy.recipientsText": "Proveedores necesarios para la operativa (p. ej., pasarela de pago, logística) y, en su caso, analítica/marketing cuando aceptes cookies no esenciales.",
      "privacy.rightsTitle": "Derechos",
      "privacy.rightsText": "Puedes ejercer acceso, rectificación, supresión, limitación, oposición y portabilidad escribiendo a info@manpowers.es.",
      "privacy.retentionTitle": "Conservación",
      "privacy.retentionText": "Los datos se conservan durante los plazos necesarios para las finalidades y obligaciones legales aplicables.",
      "privacy.cookiesTitle": "Cookies",
      "privacy.cookiesText": "Consulta la Política de Cookies para más información sobre el uso de tecnologías de seguimiento.",
      ...
      "privacy.userResponsibilitiesText": "Debes proporcionar información veraz y mantenerla actualizada. Si compartes datos de terceros, garantizas contar con su consentimiento.",
      ...
      "cookies.intro": "Utilizamos cookies propias y de terceros para finalidades necesarias, analíticas y de marketing, siempre con tu consentimiento cuando no sean imprescindibles.",
      "cookies.whatTitle": "¿Qué son las cookies?",
      "cookies.whatText": "Son archivos que se guardan en tu dispositivo para recordar preferencias, mejorar la experiencia y realizar medición de uso.",
      "cookies.typesTitle": "Tipos de cookies que usamos",
      "cookies.typesNecessary": "Necesarias: imprescindibles para el funcionamiento del sitio (autenticación, seguridad, preferencias básicas).",
      "cookies.typesAnalytics": "Analíticas: nos ayudan a entender el uso del sitio para mejorar su rendimiento y usabilidad.",
      "cookies.typesMarketing": "Marketing: personalizan el contenido y la publicidad en función de tus intereses.",
      "cookies.manageTitle": "Gestión de cookies",
      "cookies.manageText": "Puedes configurar tus preferencias en el banner de cookies o desde la configuración de tu navegador.",
      "cookies.revokeTitle": "Revocar consentimiento",
      "cookies.revokeText": "Puedes borrar el almacenamiento del navegador para restablecer el banner de consentimiento o contactar con nosotros en info@manpowers.es.",
      "cookies.detailCookiesTitle": "Información detallada",
      "cookies.functionalTitle": "Cookies funcionales",
      "cookies.functionalText": "Permiten recordar tus preferencias y opciones para una experiencia más personalizada.",
      "cookies.performanceTitle": "Rendimiento y medición",
      "cookies.performanceText": "Recopilan información anónima sobre el rendimiento del sitio para optimizarlo.",
      "cookies.thirdPartiesTitle": "Cookies de terceros",
      "cookies.thirdPartiesText": "Algunas cookies son gestionadas por terceros. Consulta sus políticas para conocer cómo tratan los datos.",
      ...
      "cookies.updateText": "Podemos actualizar esta política para reflejar cambios legales o técnicos. Revisála periódicamente.",
    },
  },
  en: {
    translation: {
      ...
      "cookies.intro": "We use our own and third-party cookies for necessary, analytics and marketing purposes, always with your consent when not strictly necessary.",
