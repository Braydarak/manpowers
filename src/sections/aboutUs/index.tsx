...
const AboutUs: React.FC = () => {
  ...
  const { count: productsCount, ref: productsRef } = useCountUp({
    end: 25,
    duration: 2000,
  });
  const { count: qualityCount, ref: qualityRef } = useCountUp({
    end: 100,
    duration: 2500,
  });
  ...
  return (
    <section
      id="about-us"
      className="bg-[var(--color-primary)] text-black py-20 px-4"
    >
      <div className="max-w-6xl mx-auto">
        ...
        >
          <h2 className="text-4xl md:text-6xl font-bold mb-6 drop-shadow-[0_0_20px_rgba(0,0,0,0.15)]">
            {t("aboutTitle")}
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
          ...
          <div
            ...
            className={`bg-[var(--color-primary)] border border-black/10 p-8 rounded-xl shadow-[0_8px_30px_rgba(0,0,0,0.08)] transition-all duration-1000 delay-400 ${
              valuesVisible
                ? "opacity-100 translate-x-0"
                : "opacity-0 translate-x-8"
            }`}
          >
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                <div className="w-2 h-2 bg-[var(--color-secondary)] rounded-full mt-3 flex-shrink-0"></div>
                <div>
                  <h5 className="font-semibold text-black">
                    {t("aboutQuality")}
                  </h5>
                  <p className="text-black/70">{t("aboutQualityDesc")}</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <div className="w-2 h-2 bg-[var(--color-secondary)] rounded-full mt-3 flex-shrink-0"></div>
                <div>
                  ...
                  <p className="text-black/70">{t("aboutInnovationDesc")}</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <div className="w-2 h-2 bg-[var(--color-secondary)] rounded-full mt-3 flex-shrink-0"></div>
                <div>
                  ...
                  <p className="text-black/70">{t("aboutCommitmentDesc")}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
          <div
            ...
            className={`bg-[var(--color-primary)] border border-black/10 p-8 rounded-xl shadow-[0_8px_30px_rgba(0,0,0,0.08)] transition-all duration-1000 delay-200 ${
              missionVisible
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-8"
            }`}
        ...
        {/* Estadísticas */}
        <div className="bg-[var(--color-primary)] border border-black/10 rounded-xl p-8 mb-20 shadow-[0_8px_30px_rgba(0,0,0,0.08)]">
          ...
          <div className="grid grid-cols-2 md:grid-cols-2 gap-8">
            ...
            <div
              ref={qualityRef as React.RefObject<HTMLDivElement>}
              className="text-center"
            >
              <div className="text-4xl md:text-5xl font-bold text-black mb-2">
                {qualityCount}%
