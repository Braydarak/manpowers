  ...
  return (
    ...
    >
      <div className="max-w-full mx-auto">
        ...
        >
          <h2 className="text-4xl md:text-6xl font-bold mb-6 uppercase drop-shadow-[0_0_20px_rgba(0,0,0,0.15)]">
            {t("sportsTitle")}
          </h2>
        ...
        >
          {sportsData.map((sport, index) => {
            return (
              <div
                key={index}
                className="group relative rounded-xl overflow-hidden shadow-[0_8px_30px_rgba(0,0,0,0.15)] transition-all duration-500 border border-black/10 h-[30rem] cursor-pointer"
                style={{
              ...
              >
                ...
                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-all duration-500 flex flex-col items-center justify-center text-center p-8 z-20 bg-opacity-40">
                  ...
                  <p className="text-lg text-[var(--color-secondary)] font-semibold mb-6 italic drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]">
                    "{t(sport.slogan)}"
                  </p>
                  <p className="text-white/90 leading-relaxed mb-8 text-sm md:text-base drop-shadow-[0_2px_6px_rgba(0,0,0,0.8)]">
                    {t(sport.description)}
                  </p>
                  <button
                    className="bg-[var(--color-secondary)] text-white font-bold py-3 px-8 rounded-lg transition-all duration-300 hover:brightness-90 hover:scale-105 shadow-lg"
                    onClick={(e) => {
                      e.stopPropagation();
